    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <main class="flex-1 space-y-6">
                                            ...
                                            <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
                                                ...
                                                <div class="flex-1 text-center md:text-left">
                                                    ...
                                                    <div class="mb-4 flex items-center justify-center md:justify-start gap-2">
                                                        ...
                                                        <span class="text-sm md:text-base opacity-90">{{ $memorial->birth_place }}</span>
                                                    </div>
                                                    @endif
                ...
                <div class="bg-white rounded-xl shadow-md p-8">
                    <h2 class="text-xl font-semibold text-slate-700 mb-4">Оставленные воспоминания</h2>
                    <div class="text-center py-12 text-gray-500">
                        <svg class="w-16 h-16 text-gray-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                        </svg>
                            ...
                            @auth
                                @if(Auth::id() === $user->id)
                                    <div class="space-y-3">
                                        ...
                                        <a href="{{ route('memorial.create') }}" class="block w-full px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors text-center font-medium">
                                            Добавить мемориал
                                        </a>
                                    </div>
                                @else
