<div class="bg-white rounded-xl shadow-md overflow-hidden">
    ...
    <div class="p-6">
        @if((isset($allPhotos) && count($allPhotos) > 0) || (isset($allVideos) && count($allVideos) > 0))
            ...
            <div class="mb-6">
                <h4 class="text-md font-semibold text-slate-700 mb-3">Фотографии ({{ count($allPhotos) }})</h4>
            ...
            <div>
                <h4 class="text-md font-semibold text-slate-700 mb-3">Видео ({{ count($allVideos) }})</h4>
