                        <div x-show="activeTab === 'basic'" class="space-y-6">
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-4 sm:p-6 border border-blue-100">
                                ...
                                <div class="flex flex-col sm:flex-row gap-4 sm:gap-6" x-data="photoUpload()">
                                    <!-- Фото -->
                                    <div class="flex-shrink-0 mx-auto sm:mx-0">
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Фото *</label>
                                        <div class="w-40 h-40 sm:w-56 sm:h-56 bg-white rounded-2xl flex items-center justify-center overflow-hidden border-2 border-dashed border-blue-200 hover:border-blue-300 transition-colors cursor-pointer" onclick="document.getElementById('photo').click()">
                                            <img x-show="previewUrl" :src="previewUrl" class="w-full h-full object-cover">
                                            <svg x-show="!previewUrl" class="w-16 h-16 sm:w-20 sm:h-20 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="flex-1 space-y-3 sm:space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="last_name" id="last_name" value="{{ old('last_name', $memorial->last_name) }}" required class="w-full px-3 py-2 sm:px-4 sm:py-2.5 bg-white border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base">
                                        </div>

                                        <!-- Имя -->
                                        <div>
                                            <label for="first_name" class="block text-sm font-medium text-gray-700 mb-1.5">Имя *</label>
                                            <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $memorial->first_name) }}" required class="w-full px-3 py-2 sm:px-4 sm:py-2.5 bg-white border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base">
                                        </div>

                                        <!-- Отчество -->
                                        <div>
                                            <label for="middle_name" class="block text-sm font-medium text-gray-700 mb-1.5">Отчество</label>
                                            <input type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $memorial->middle_name) }}" class="w-full px-3 py-2 sm:px-4 sm:py-2.5 bg-white border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Блок: Даты жизни -->
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-4 sm:p-6 border border-blue-100">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Даты жизни</h3>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 sm:gap-5">
                                    ...
                                    <div class="sm:col-span-1 lg:col-span-3">
                                        ...
                                        <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date', $memorial->birth_date?->format('Y-m-d')) }}" required class="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base">
                                    </div>

                                    <!-- Дата смерти -->
                                    <div class="sm:col-span-1 lg:col-span-3">
                                        <label for="death_date" class="block text-sm font-medium text-gray-700 mb-2">Дата смерти *</label>
                                        <input type="date" name="death_date" id="death_date" value="{{ old('death_date', $memorial->death_date?->format('Y-m-d')) }}" required class="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base">
                                    </div>

                                    <!-- Место рождения -->
                                    <div class="sm:col-span-2 lg:col-span-6" x-data="birthPlaceAutocomplete()">
                                        ...
                                        <div class="relative">
                                            <input 
                                                ...
                                                class="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base"
                                            >
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-4 sm:p-6 border border-blue-100">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Дополнительная информация</h3>
                                ...
                                <div class="space-y-4 sm:space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <select name="religion" id="religion" class="w-full px-3 py-2 sm:px-4 sm:py-3 bg-white border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base">
