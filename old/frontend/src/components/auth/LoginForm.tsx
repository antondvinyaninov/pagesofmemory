  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white rounded-card shadow-lg p-8">
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-slate-700 mb-2">Вход в систему</h1>
          <p className="text-gray-500">Введите ваши данные для входа</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              id="password"
              className="w-full px-4 py-3 pr-12 border-2 border-gray-100 rounded-md focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 transition-colors"
